...
//    jrc_pick_place.pickPlacePipleline();
    ...
    SIAMotionPlanner motion_planner(nh);
    ...
    std::vector<double> joint_values = {-2.32403999964,
										...
										-2.19070560137,
										1.03023681641};
    std::vector<double> joint_values_pre = {1.55030405521, -1.961748902, 1.51336669922, 0.365389347076, 1.54746341705, 0.0328536294401};
    
    std::vector<double> joint_values_home = {};

    // if(use_arm == "left")
        // motion_planner.setJointValueTarget(joint_values_pre_l);
    // if(use_arm == "right")
        motion_planner.setJointValueTarget(joint_values_pre);
