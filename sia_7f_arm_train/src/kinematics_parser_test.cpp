...
int main(int argc, char** argv)
{
    ...
    std::vector<std::string> sia_7f_arm_joint_names_ = {"sia_7f_arm_joint1",
                          "sia_7f_arm_joint2", 
                          "sia_7f_arm_joint3", 
                          "sia_7f_arm_joint4", 
                          "sia_7f_arm_joint5", 
    ...
    std::string moveit_traj_arm_base_frame_ = "sia_7f_arm_base_link";
    ...
    //                                     0.841070054649, 
    //                                     -0.874129776051};
    std::vector<double> joint_values = {-0.32403999964,
                                        1.12740451494,
                                        -1.71879083315,
                                        1.06987525622,
                                        -1.19070560137,
	...
	for (int k = 0; k < 6; k++) {
		std::stringstream jointName;
            jointName << sia_7f_arm_joint_names_[k];
